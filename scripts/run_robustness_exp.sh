...
# 'mmw_book_report','mmw_story','mmw_fake_news','dolly_cw','longform_qa','finance_qa','c4_subset'
dataset_name="c4_subset"

# 'mcmark': run mcmark with l=20
# 'main_exp' run main experiments
# 'mcmark_ablation' run ablation study
reweight_type='mcmark'
openai_api_key='sk-09cb6c179e1941fdb8fbe7aba4bad07d'
